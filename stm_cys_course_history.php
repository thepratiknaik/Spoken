...
<head>
    ...
    <title>CYBER SECURITY COURSE HISTORY</title>
...
<body style="background-image: linear-gradient(270deg,#d53685,#16abbe);">
    ...
    <table class="mx-auto my-3" border="2">
        ...
        $query = "select * from `stm_cys_course_history`";
        ...
        $query = "SELECT *FROM `stm_cys_course_history` LIMIT " . $page_first_result . ',' . $results_per_page;
        $result = mysqli_query($conn, $query);
    ...
    <div class="mx-auto my-2" style="width: 200px;">
                ...
                for ($page = 1; $page <= $number_of_page; $page++) {
                    echo '<a class="btn btn-primary mx-3" href = "stm_cys_course_history.php?page=' . $page . '">' . $page . ' </a>';
                }
